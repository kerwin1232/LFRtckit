...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraCIExtension.framework"
  ...
  install_framework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraVideoProcessExtension.framework"
