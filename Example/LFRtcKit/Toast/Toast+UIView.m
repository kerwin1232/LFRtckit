...
static const CGFloat CSToastHorizontalPadding   = 30.0;
...
// activity
static const CGFloat CSToastActivityWidth       = 120.0;
static const CGFloat CSToastActivityHeight      = 114.0;
...
- (void)makeToastActivity:(id)position {
    ...
    activityView.backgroundColor = [[UIColor colorWithRed:50/255.0 green:61/255.0 blue:81/255.0 alpha:1.0] colorWithAlphaComponent:CSToastOpacity];
